...
This was only posted for a S&Box Application, but if you want to use it go ahead, this is a little on how it works right now(Most likely going to improve upon in future):
